  ...
  return (
    <div className="min-h-screen bg-[#020617] flex flex-col items-center justify-center relative overflow-hidden text-white">
      ...
      <div className="relative z-10 w-full max-w-md p-6 animate-in fade-in zoom-in duration-500">
        <div className="glass p-10 rounded-3xl text-center shadow-2xl border border-white/10 bg-white/5 backdrop-blur-xl">
          ...
          <p className="text-slate-400 mb-8 text-sm">Sign in to access your creative dashboard.</p>

          <button 
            onClick={handleLogin}
            className="w-full bg-white text-black py-4 rounded-xl font-bold text-sm hover:bg-gray-200 transition-all flex items-center justify-center gap-3 mb-4 group shadow-lg"
          >
